...
Either manually install the gem (using the --pre option since it is still beta)

@gem install --pre sinatra-simple-navigation@

or preferably use bundler and add it to your Gemfile

@gem 'sinatra-simple-navigation', '3.0.0.beta1'@
